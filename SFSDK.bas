...
#If Debugging = 0 Then
  #If VBA7 Then
    Public Declare PtrSafe Function NDK_Init Lib "DllName" Alias "#100" (ByVal szAppName As String, _
...
Attribute NDK_X12_RUN_STAT.VB_Description = "Examine the status of running X12a program"
...
Attribute NDK_X12_OUT_FILE.VB_Description = "return the full name of the x12a output file"
...
Attribute NDK_X12_OUT_SERIES.VB_Description = "return the output time series (seasonally adjusted)"
...
Attribute NDK_X12_FORE_SERIES.VB_Description = "return the forecast output time series"
...
Attribute NDK_PORTFOLIO_RET.VB_Description = "Compute the portfolio equivalent returns"
...
Attribute NDK_PORTFOLIO_VARIANCE.VB_Description = "Calculates the overall portfolio variance (volatility squared)"
...
Attribute NDK_PORTFOLIO_COVARIANCE.VB_Description = "Calculates the covariance between two portfolios"
  #Else
